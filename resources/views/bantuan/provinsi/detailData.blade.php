...
@include('sweet::alert')
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="card-body">
                                    <div style="text-align: center;">
                                        ...
                                        <h4 class="card-title">Bantuan BPBD Provinsi <b>{{ $bantuanProvinsis->proposalProvinsi->provinsi->provinsi }}</b></h4>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input id="jenis_bantuan" type="text" name="jenis_bantuan" required class="form-control" disabled value="{{ $bantuanProvinsis->jenis_bantuan }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-sm-1 text-right control-label col-form-label">:</label>
                                        <div class="col-sm-9">
                                            <input id="keterangan" type="text" name="keterangan" required class="form-control" value="{{ $bantuanProvinsis->keterangan }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group col-sm-9">
                                            ...
                                            <input id="nilai" type="text" name="nilai" required class="form-control" value="{{ $bantuanProvinsis->nilai }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <label class="col-sm-1 text-right control-label col-form-label">:</label>
                                        <div class="col-sm-9">
                                            <input id="risiko" type="text" name="risiko" required class="form-control" value="{{ $bantuanProvinsis->risiko }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <label class="col-sm-1 text-right control-label col-form-label">:</label>
                                        <div class="col-sm-9">
                                            <input id="pembentukan" type="text" name="pembentukan" required class="form-control" disabled value="{{ $bantuanProvinsis->pembentukan }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group col-sm-9">
                                            ...
                                            <input type="text" required class="form-control" data-date-format='dd MM yyyy' id="tahun" placeholder="Tahun Perolehan" name="tahun_perolehan" value="{{ $bantuanProvinsis->tahun_perolehan }}" disabled>
                                        </div>
                                    </div>
                                    <hr>
                                @if(!empty($bastoProvinsis))
                                    <h4><i class="fas fa-hands"></i> <b>DATA BASTO</b></h4>
                                    @if(!empty($bastoProvinsis->nomor_basto_file))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group col-sm-8 col-8">
                                            ...
                                            <input id="nomor_basto" type="text" name="nomor_basto" required class="form-control" value="{{ $bastoProvinsis->nomor_basto }}" disabled>
                                        </div>
                                    ...
                                    @endif
                                    @if(!empty($bastoProvinsis->no_permohonan_hibah_file))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group col-sm-8 col-8">
                                            ...
                                            <input id="no_permohonan_hibah" type="text" name="no_permohonan_hibah" required class="form-control" value="{{ $bastoProvinsis->no_permohonan_hibah }}" disabled>
                                        </div>
                                        <div class="col-sm-1 col-1 action-table" style="display: flex;align-items: center;">
                                    ...
                                    @endif
                                    @if(!empty($bastoProvinsis->no_bersedia_menerima_hibah_file))
       ...
       <label class="col-sm-1 text-right control-label col-form-label">:</label>                                 <div class="input-group col-sm-8 col-8">
                                            ...
                                            <input id="no_bersedia_menerima_hibah" type="text" name="no_bersedia_menerima_hibah" required class="form-control" value="{{ $bastoProvinsis->no_bersedia_menerima_hibah }}" disabled>
                                        </div>
                                        <div class="col-sm-1 col-1 action-table" style="display: flex;align-items: center;">
       ...
       <label class="col-sm-1 text-right control-label col-form-label">:</label>                                 <div class="input-group col-sm-8 col-8">
                                    ...
                                    @endif
                                    @if(!empty($bastoProvinsis->no_inventarisasi_barang_file))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group col-sm-8 col-8">
                                            ...
                                            <input id="no_inventarisasi_barang" type="text" name="no_inventarisasi_barang" required class="form-control" value="{{ $bastoProvinsis->no_inventarisasi_barang }}" disabled>
                                        </div>
                                        <div class="col-sm-1 col-1 action-table" style="display: flex;align-items: center;">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group col-sm-8 col-8">
                                            ...
                                            <input id="bast_hibah" type="text" name="bast_hibah" required class="form-control" value="{{ $bastoProvinsis->bast_hibah }}" disabled>
                                        </div>
                                        <div class="col-sm-1 col-1 action-table" style="display: flex;align-items: center;">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group col-sm-8 col-8">
                                            ...
                                            <input id="nasah_hibah" type="text" name="nasah_hibah" required class="form-control" value="{{ $bastoProvinsis->nasah_hibah }}" disabled>
                                        </div>
                                        <div class="col-sm-1 col-1 action-table" style="display: flex;align-items: center;">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group col-sm-9">
                                            ...
                                            <input id="nilai_bantuan" type="text" name="nilai_bantuan" required class="form-control" value="{{ $bastoProvinsis->nilai_bantuan }}" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group col-sm-8 col-8">
                                            ...
                                            <input id="rincian" type="text" name="rincian" required class="form-control" value="{{ $bastoProvinsis->rincian }}" disabled>
                                        </div>
                                        <div class="col-sm-1 col-1 action-table" style="display: flex;align-items: center;">
