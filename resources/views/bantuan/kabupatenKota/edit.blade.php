                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-body">
                                                ...
                                                <embed src="{{ asset('UploadedFile/Proposal') }}/{{ $bantuanKabupatenKotas->id_provinsi }}/{{ $bantuanKabupatenKotas->id_kabupatenKota }}/{{ $bantuanKabupatenKotas->jenis_bantuan }}/{{ $bantuanKabupatenKotas->proposalKabupatenKota->isi_ringkasan }}" style="width: 100%;height: 100%;"></embed>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-xl-7 col-lg-10 col-md-12 col-sm-12">     
                        <div class="card">
                            <form class="form-horizontal" method="POST" action="{{ url('dataBantuan/kabupatenKota/prosesEditBantuanKabupatenKota/'.$bantuanKabupatenKotas->id) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="id_provinsiBantuan" class="select2 form-control" name="id_provinsi" required>
                                                ...
                                                <optgroup label="Provinsi di Indonesia">
                                                    ...
                                                    @if($bantuanKabupatenKotas->proposalKabupatenKota->kabupatenKota->provinsi->id == $res->id_provinsi)
                                                    <option value="{{ $res->id_provinsi }}" selected>{{ $res->provinsi }}</option>
                                                    @else
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="bpbd_kabKot" class="select2 form-control" name="id_proposalKabupatenKota" required>
                                                <option value="{{ $bantuanKabupatenKotas->id_proposalKabupatenKota }}" selected>BPBD {{ $bantuanKabupatenKotas->proposalKabupatenKota->kabupaten_kota }} - {{ $bantuanKabupatenKotas->jenis_bantuan }}</option>
                                            </select>
                                            <input type="hidden" name="jenis_bantuan" id="jenis_bantuan" value="{{ $bantuanKabupatenKotas->jenis_bantuan }}">
                                            <input type="hidden" name="id_kabupatenKota" id="id_kabupatenKota" value="{{ $bantuanKabupatenKotas->id_kabupatenKota }}">
                                            <input type="hidden" name="id_provinsi" id="id_provinsi" value="{{ $bantuanKabupatenKotas->id_provinsi }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2 col-lg-1 col-2" style="display: flex;align-items: center;">
                                            @if(!empty($bantuanKabupatenKotas->proposalKabupatenKota->isi_ringkasan))
                                            <a href="#" id="open-file" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#ModalBantuanKabKot"><i class="mdi mdi-open-in-new"></i></a>
                                            @else
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input id="keterangan" type="text" name="keterangan" required class="form-control" value="{{ $bantuanKabupatenKotas->keterangan }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group col-sm-9">
                                            ...
                                            <input id="nilai" type="text" name="nilai" required class="form-control" value="{{ $bantuanKabupatenKotas->nilai }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="risiko" class="col-sm-3 text-right control-label col-form-label">Risiko</label>
                                        <div class="col-sm-9">
                                            <input id="risiko" type="text" name="risiko" required class="form-control" value="{{ $bantuanKabupatenKotas->risiko }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="pembentukan" class="select2 form-control" name="pembentukan" required>
                                                ...
                                                <optgroup label="Iya Atau Tidak">
                                                    ...
                                                    @if($bantuanKabupatenKotas->pembentukan == $res->pembentukan)
